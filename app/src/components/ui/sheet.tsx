...
function Sheet({ ...props }: SheetPrimitive.Dialog.Root.Props) {
  return <SheetPrimitive.Dialog.Root data-slot="sheet" {...props} />
}

function SheetClose({ ...props }: SheetPrimitive.Dialog.Close.Props) {
  return <SheetPrimitive.Dialog.Close data-slot="sheet-close" {...props} />
}

function SheetPortal({ ...props }: SheetPrimitive.Dialog.Portal.Props) {
  return <SheetPrimitive.Dialog.Portal data-slot="sheet-portal" {...props} />
}

function SheetOverlay({ className, ...props }: SheetPrimitive.Dialog.Backdrop.Props) {
  return (
...
function SheetContent({
  ...
  ...props
}: SheetPrimitive.Dialog.Popup.Props & {
...
function SheetTitle({ className, ...props }: SheetPrimitive.Dialog.Title.Props) {
  return (
...
function SheetDescription({
  className,
  ...props
}: SheetPrimitive.Dialog.Description.Props) {
  return (
