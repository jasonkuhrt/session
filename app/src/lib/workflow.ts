 ...
 * the CLI write it. The hint is a sentence because it is the only explanation
 * either surface gives: the board hangs it off the lane's heading, the index
 * off its column, and the item page off the move it would make.
 */
