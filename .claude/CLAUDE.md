...
dated in their tooltips, with a named notice in their place when a source cannot
answer, and the terminal action asks `cmux` when it is clicked and shows cmux's
